...
import net.dudehook.cliche2.util.EmptyMultiMap;
...
public class ShellFactory
{
    ...
    /**
     * Facade method for operating the Shell allowing specification of auxiliary handlers (i.e. handlers that are to be
     * passed to all subshells).
     * 
     * Run the obtained Shell with commandLoop().
     * 
     * @see asg.cliche.Shell#Shell(asg.cliche.Shell.Settings, asg.cliche.CommandTable, java.util.List)
