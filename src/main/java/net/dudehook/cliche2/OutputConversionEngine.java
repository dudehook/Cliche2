...
/**
 * Output conversion engine is responsible for converting objects after they are returned by command but before they are
 * sent to the Output. As with InputConversionEngine, it can automatically retrieve all converters declared inside an
 * object.
 * 
