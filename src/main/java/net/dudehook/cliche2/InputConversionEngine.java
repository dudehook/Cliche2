...
/**
 * This thing is responsible for converting strings to objects. Elementary types can be handled by itself, and arbitrary
 * types can be handled by registering InputConverter instances. It also gets all converters declared in a handler
 * object through addDeclaredConverters method.
 * 
...
public class InputConversionEngine
{
    ...
    public void addDeclaredConverters(Object handler)
    {
        ...
        {
            if (field.getName().startsWith(PREFIX) && field.getType().isArray()
