...
/**
 * Classes that want to have an instance of Shell associated with them should implement this interface. Upon
 * registration in Shell, cliSetShell() is called.
 * 
 * @author ASG
 */
