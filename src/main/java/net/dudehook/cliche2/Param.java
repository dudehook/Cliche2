...
/**
 * Annotation for parameters of Command-marked methods. This annotation is of particular usefullness, because Java 5
 * Reflection doesn't have access to declared parameter names (there's simply no such information stored in classfile).
...
{
    /**
     * Parameter name. Should (1) reflect the original Java parameter name, (2) be short and descriptive to the user.
